...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 flex w-full justify-between bg-slate-950 text-slate-50 dark:bg-slate-950 ">
      ...
      >
        <img src="./it.png" width="30" alt=""></img>
        <h1 className="m-0 pr-1 font-spectral text-slate-50 decoration-violet-500 decoration-[3px] underline-offset-[3px] hover:underline whitespace-nowrap">
          IIT BHILAI
        </h1>
      </Link>
      <Link
